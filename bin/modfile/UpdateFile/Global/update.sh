...
if [[ $regionTYPE == *"Global"* ]]; then 
  ...
  cp -rf $work_dir/bin/modfile/UpdateFile/Global/DeadZone.MiuiSystemUIPlugin.apk $work_dir/build/baserom/images/product/overlay/
  cp -rf $work_dir/bin/modfile/UpdateFile/Global/DeadZone.MiuiSystemUI.apk $work_dir/build/baserom/images/product/overlay/
  cp -rf $work_dir/bin/modfile/UpdateFile/Global/DeadZone.HyperPhoneSystemUI.apk $work_dir/build/baserom/images/product/overlay/
  #Fix icon
fi